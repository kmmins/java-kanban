...
public class TaskManager {
    ...
    /////////////////////////////////////////////////
    /*объект должен передаваться в качестве параметра*/
    ...
    public void createSubTask(SubTask task) {
        subTaskCounterId +=1;
        subTaskData.put(subTaskCounterId, new SubTask(subTaskCounterId, task.getName(), task.getDescription(), task.getStatus(), task.getEpicId()));
    }
    public void createEpic(Epic task) {
        epicCounterId +=1;
        epicData.put(epicCounterId, new Epic(epicCounterId, task.getName(), task.getDescription(), evaluateEpicStatus(task)));
    }
    /////////////////////////////////////////////////
